...
public abstract class BaseDisc {
    ...
    public int getStorageCapacity() { return storageCapacityInMB; }

    public int getSpinSpeed() { return spinSpeedInRPM; }

    protected void writeData(String data) { this.discData+=data; }
    public String readData() { return this.discData; }
    public HashMap<String, String> getInfo() { return this.discInfo; }
    public void insert() { this.isInserted = true; }
}
